...
options = {
    ...
    'input':'osso-implante-titanium',
    'inputFormat':INP,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'osso-implante-titanium',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'listener_name':'MCLAREN.lti-dem.dem.ist.utl.pt',
    'listener_resource':'7724',
    'magnetostatic':OFF,
    'massDiffusion':OFF,
    ...
    'thermal':OFF,
    'tmpdir':'C:\\Users\\LTIAUL~1\\AppData\\Local\\Temp',
    'tracer':OFF,
